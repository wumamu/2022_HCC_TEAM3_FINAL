...
if(NOT "include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
