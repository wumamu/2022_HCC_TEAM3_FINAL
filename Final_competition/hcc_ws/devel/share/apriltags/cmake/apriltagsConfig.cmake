...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/mamu/hcc_2022/Final_competition/hcc_ws/src/apriltags_ros/apriltags)
  set(apriltags_DEVEL_PREFIX /home/mamu/hcc_2022/Final_competition/hcc_ws/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/mamu/hcc_2022/Final_competition/hcc_ws/install)
...
if(NOT "/home/mamu/hcc_2022/Final_competition/hcc_ws/src/apriltags_ros/apriltags/include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/mamu/hcc_2022/Final_competition/hcc_ws/src/apriltags_ros/apriltags/include;/usr/include/eigen3;/usr/include/opencv4")
  ...
  elseif(NOT "http://people.csail.mit.edu/kaess/apriltags/ " STREQUAL " ")
    set(_report "Check the website 'http://people.csail.mit.edu/kaess/apriltags/' for information and consider reporting the problem.")
  else()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT apriltags_NUM_DUMMY_TARGETS)
      set(apriltags_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::apriltags::wrapped-linker-option${apriltags_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR apriltags_NUM_DUMMY_TARGETS "${apriltags_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::apriltags::wrapped-linker-option${apriltags_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND apriltags_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(apriltags_EXPORTED_TARGETS ${${apriltags_dep}_EXPORTED_TARGETS})
endforeach()
